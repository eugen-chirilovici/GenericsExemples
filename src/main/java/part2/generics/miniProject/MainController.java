...
//    }
    ...
    public static void main(String[] args) {
        ...
        intern.setFirstName("Johny");
        intern.setLastName("Bravo");
        intern.setId(14l);
        intern.setAge(18l);
        intern.setDiscipline("AM");
        listOfUsers.add(intern);

        InternService internService = new InternServiceImpl();
        internService.saveInterns(intern);
//        System.out.println(internService.getInternById(14l));
//        System.out.println(internService.getInterns());
        System.out.println(internService.getInternByName("Johny"));
